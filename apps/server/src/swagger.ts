...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    info: {
      title: 'Weather API',
      version: '1.0.0',
      description: 'API for retrieving weather data with historical average temperature information',
      contact: {
        name: 'API Support',
        ...
        WeatherAverageResponse: {
          ...
          properties: {
            overallAverageTemperature: {
              type: 'number',
              description: 'Average temperature across the requested time period',
              example: 18.3
            },
            dailyTemperatures: {
              type: 'array',
            ...
            fetchedLocationName: {
              type: 'string',
              description: 'Name of the location as resolved by the geocoding service',
              example: 'London'
            },
            daysFetched: {
              type: 'integer',
